 ...
 *
 * Event fired when a Location is updated.
 *
 * @package JobMetric\Location\Events\Location
 */
readonly class LocationUpdateEvent implements DomainEvent
{
    /**
    ...
    public static function definition(): DomainEventDefinition
    {
        return new DomainEventDefinition(
            ...
            'location::base.events.location_updated.title',
            'location::base.events.location_updated.description',
            'fas fa-edit',
            [
                'location',
                'update',
