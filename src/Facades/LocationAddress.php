 ...
 * @method static array get(int $location_address_id, array $with = [], string $mode = null)
 ...
 * @method static array delete(int $location_address_id)
 * @method static array restore(int $location_address_id)
 * @method static array forceDelete(int $location_address_id)
 *
